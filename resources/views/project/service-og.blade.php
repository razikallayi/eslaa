    ...
    <div class="container">
      <div class="col-md-12 no-padding">
        <ul class="clearfix">
          ...
          <li id="a"><a href="" data-modal="#modal" class="modal__trigger"><img src="{{url('project/images/icons/a.svg')}}"><h4>Arbitration</h4></a></li>
          <li id="cc"><a href="" data-modal="#modal1" class="modal__trigger"><img src="{{url('project/images/icons/cc.svg')}}"><h4>Corporate & Commercial</h4></a></li>
          <li id="ec"><a href="" data-modal="#modal3" class="modal__trigger"><img src="{{url('project/images/icons/ec.svg')}}"><h4>Engineering & Construction</h4></a></li>
          <li id="le"><a href="" data-modal="#modal6" class="modal__trigger"><img src="{{url('project/images/icons/le.svg')}}"><h4>Labour & Employment</h4></a></li>
          <li id="pr"><a href="" data-modal="#modal7" class="modal__trigger"><img src="{{url('project/images/icons/pr.svg')}}"><h4> Property & Real State</h4></a></li>
          <li id="m"><a href="" data-modal="#modal4" class="modal__trigger"><img src="{{url('project/images/icons/mt.svg')}}"><h4>Maritime</h4></a></li>
          <li id="fb"><a href="" data-modal="#modal2" class="modal__trigger"><img src="{{url('project/images/icons/fb.svg')}}"><h4> Finance & Banking</h4></a></li>
          <li id="ie"><a href="" data-modal="#modal5" class="modal__trigger"><img src="{{url('project/images/icons/liti.svg')}}"><h4>Litigation</h4></a></li>
          <li id="c"><a href="" data-modal="#modal8" class="modal__trigger"><img src="{{url('project/images/icons/c.svg')}}"><h4>Criminal</h4></a></li>
          <li id="s"><a href="" data-modal="#modal9" class="modal__trigger"><img src="{{url('project/images/icons/s.svg')}}"><h4>Sports</h4></a></li>
        </ul>
      </div>
    </div>
  </div>
